    ...
    <>
      ...
      <div className="w-3/4 border border-blue-900 mx-auto p-8">
        <form>
          ...
          <div className="flex justify-around">
            <div>
              <h1 className="m-5 text-2xl text-center">Adicionar Carga</h1>
              <div className="flex">
                <div>
            ...
            <div>
              <h1 className="m-5 text-2xl">Cargas</h1>
            </div>
          </div>
          <Divider />
          <div className="flex justify-around">
          ...
          <div className="flex justify-around">
            <div>
              ...
              <Input
                type={"radio"}
                content={"Contratado"}
                name={"estadoDaContratacao"}
              />
              <br />
              <Input
                type={"radio"}
                content={"Não Contratado"}
                name={"estadoDaContratacao"}
              />
            </div>
            <div>
          ...
          <button
            className="text-3xl mx-auto block mt-6 bg-green-500 py-2 px-6 border border-black"
            type="submit"
          >
            Salvar Proposta
          </button>
