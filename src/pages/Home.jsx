    ...
    <div className="flex h-screen w-screen">
      ...
      <main className="h-screen w-3/5">
        ...
        <div className="flex mx-auto mt-16 flex-col">
          <Input placeholder={"Usuário"} width={'w-80'} />
          <Input placeholder={"Senha"} width={'w-80'} />
        </div>
      ...
      <div className={`absolute w-1/3 h-3/4 bg-gray-100 m-auto inset-0 border border-black`}>
